...
namespace APIVerve
{
    public class DomainAvailabilityAPIClient
    {
        ...
        public DomainAvailabilityAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public DomainAvailabilityAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
